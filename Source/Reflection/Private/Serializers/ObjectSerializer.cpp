...
UObject* UObjectSerializer::SpawnExport(FUObjectExport* Export, const bool bOnlySerialize) {
	const FJsonDebug::FScopedJsonDebugContext JsonCtx(FString::Printf(
		TEXT("SpawnExport %s (%s) @%d"), *Export->GetName().ToString(), *Export->GetType().ToString(), Export->Position));
...
void UObjectSerializer::DeserializeExport(FUObjectExport* Export, TMap<TSharedPtr<FJsonObject>, UObject*>& ExportsMap) {
	...
	const FJsonDebug::FScopedJsonDebugContext JsonCtx(FString::Printf(
		TEXT("DeserializeExport %s (%s) @%d"), *Export->GetName().ToString(), *Export->GetType().ToString(), Export->Position));
...
void UObjectSerializer::DeserializeObjectProperties(const TSharedPtr<FJsonObject>& Properties, UObject* Object) const {
	...
	const FJsonDebug::FScopedJsonDebugContext JsonCtx(FString::Printf(
		TEXT("DeserializeObjectProperties %s (%s)"), *Object->GetFullName(), *Object->GetClass()->GetName()));
